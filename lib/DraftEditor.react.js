  ...
  _proto2._buildHandler = function _buildHandler(eventName) {
    ...
    return function (e) {
      var _this2$props = _this2.props,
          ...
          _this2$props$editable = _this2$props.editabledTypes,
          editabledTypes = _this2$props$editable === void 0 ? [] : _this2$props$editable,
          _this2$props$editable2 = _this2$props.editabledEvents,
          editabledEvents = _this2$props$editable2 === void 0 ? [] : _this2$props$editable2,
          _this2$props$disabled = _this2$props.disabledEvents,
          disabledEvents = _this2$props$disabled === void 0 ? [] : _this2$props$disabled;
      var key = editorState.getSelection().getStartKey();
      var currentBlock = editorState.getCurrentContent().getBlockMap().find(function (block) {
        return block.get('key') === key;
      });
      var type = currentBlock.get('type');

      if (!_this2.props.readOnly && (editabledEvents.indexOf(eventName) !== -1 || editabledTypes.indexOf(type) !== -1) && disabledEvents.indexOf(eventName) === -1) {
